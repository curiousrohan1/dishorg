const titles = app.component('Titles', {
    ...
    <div>
        <div style="position:relative;width:49%;float:left;padding-left:1rem;">
            ...
            <button class="btn btn-light text-info" data-placement="right" data-toggle="tooltip" id="plus-rec"
        ...
        <div>
            ...
            <div id="renamed-recipe-name" v-show="showRename">
                ...
                <button class="btn btn-success" id="apply-rec-rename"><img src="images/apply.png" style="width:30px;height:30px;"></button>
                <button class="btn btn-danger" id="cancel-rec-rename" v-on:click = "cancelRecRename"><img src="images/cancel.jpg" style="width:30px;height:30px;"></button>
            </div>
            <button class="btn" id="edit-rec-name" v-on:click="editRecName" v-show="!showRename"><img src="images/edit.jpg" style="width:30px;height:30px;"></button>
            <button class="btn" id="del-rec"><img src="images/del.png"  v-show="!showRename"style="width:30px;height:30px;"></button>
            <button class="btn btn-light text-info" data-placement="left" data-toggle="tooltip" id="plus-ing"
